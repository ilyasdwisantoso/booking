            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->merge('/storage/app/unj_sikiar.png')->errorCorrection('L')->size(200)->generate($dosen->qr_code)) !!}" alt="QR Code">
                    </td>
                </tr>
            </table>
        </div>
