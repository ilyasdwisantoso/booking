                    ...
                    <table class="table table-bordered table-striped table-hover datatable datatable-customer" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $m->id }}">
                                ...
                                <td>{{$m->tgl_lahir}}</td>
                                <td>
                                    <a href="{{ route('admin.mahasiswa.edit', $m->id) }}" class="btn btn-info">
                                        <i class="fa fa-pencil-alt"></i>
                                    </a>
                                    <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('admin.mahasiswa.destroy', $m->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
