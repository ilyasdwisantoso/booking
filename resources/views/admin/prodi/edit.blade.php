...
<!-- Content Row -->
        <div class="card shadow">
            ...
            <h1 class="h3 mb-0 text-gray-800">{{ __('Edit prodi') }}</h1>
                <div class="ml-auto">
            ...
            <div class="card-body">
                <form action="{{ route('admin.prodi.update', $prodi->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_prodi" placeholder="{{ __('nama prodi') }}" name="nama_prodi" value="{{ old('prodi', $prodi->nama_prodi) }}" />
                    </div>
