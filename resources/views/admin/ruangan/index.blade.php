            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    ...
                    <a href="{{ route('admin.ruangan.create') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('New Ruangan') }}</span>
                    </a>
                    @endcan
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-striped table-hover datatable datatable-Category" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $r->id }}">
                                ...
                                <td>{{ $r->lantai }}</td>
                                <td>
                                    <a href="{{ route('admin.ruangan.edit', $r->id) }}" class="btn btn-info">
                                        <i class="fa fa-pencil-alt"></i>
                                    </a>
                                    <form onclick="return confirm('apakah anda yakin ? ')" class="d-inline" action="{{ route('admin.ruangan.destroy', $r->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.ruangan.mass_destroy') }}",
